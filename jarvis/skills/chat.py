...
CHAT_SYSTEM = (
    ...
    # After a failed switch it claimed "ผมไม่สามารถควบคุมอุปกรณ์ไฟฟ้าในบ้านได้".
    "คุณสั่งเปิดปิดไฟโต๊ะผ่าน ESP32 ในบ้านได้ ถ้าสั่งไม่สำเร็จให้อธิบายสาเหตุจากข้อมูลจริง "
