...
5. **ตื่นเองจากเสียงรบกวน:** 21:44–23:04 ของ 2026-09-24 ตื่นเอง ~30 ครั้ง ได้คำหลอนของ
...
6. **โหมดทำงาน** แบบห้องแล็บ Tony: "จาวิส เริ่มทำงาน" แล้วคุยได้ไม่ต้องเรียกชื่อจนพูด "พอแล้ว"
...
3. **ตั้งปลุก** (แยกจากเตือนความจำ): "ปลุกผมตีห้าครึ่ง" / "ปลุกทุกวันธรรมดา 7 โมง"
   ...
   - ตอนนี้ "ปลุก" ใช้ระบบเตือนความจำไปก่อน พูดครั้งเดียว
